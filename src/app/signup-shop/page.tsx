...
import { Printer, Loader2, Rocket, ArrowRight, Store, User, Mail, Phone, Lock, MapPin } from 'lucide-react';
...
export default function ShopSignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Create User Profile with role shop_owner
      ...
      toast({ title: "Shop Created!", description: "Welcome to PrintFlow Management." });
      ...
      <Card className="w-full max-w-2xl shadow-2xl border-2">
        <CardHeader className="text-center space-y-1">
          <CardTitle className="text-2xl font-black flex items-center justify-center gap-2">
            <Rocket className="w-6 h-6 text-primary" /> Launch Your Store
          </CardTitle>
          <CardDescription>Join our multi-tenant platform and start managing today</CardDescription>
        </CardHeader>
        <form onSubmit={handleSubmit}>
          <CardContent className="space-y-4">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input required placeholder="+123..." value={formData.phone} onChange={(e) => setFormData({...formData, phone: e.target.value})} className="pl-9" />
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input required placeholder="123 Printing Ave, City" value={formData.address} onChange={(e) => setFormData({...formData, address: e.target.value})} className="pl-9" />
          ...
          <CardFooter className="flex flex-col gap-4">
            <Button type="submit" className="w-full h-12 text-lg font-bold shadow-lg" disabled={loading}>
              {loading ? <Loader2 className="animate-spin w-5 h-5" /> : "Register Your Business"}
